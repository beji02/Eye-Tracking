...
def __FuncTest__():
  ...
  with open(sys.argv[3]) as infile:
    ...
    for line in lines:
      ...
      point = np.array(line[1:3]).astype("float")
      ...
      direction = np.array(line[24: 27]).astype("float") - np.array(line[21: 24]).astype("float")
      #direction = direction / np.linalg.norm(direction)
      # origin = np.array(line[35: 38]).astype("float")
      origin = np.array(line[21:24]).astype("float")
      print(origin)
...
# python -m gaze_utils.gazeconversion /mnt/d/Downloads/MPIIFaceGaze/MPIIFaceGaze/p00/Calibration/monitorPose.mat /mnt/d/Downloads/MPIIFaceGaze/MPIIFaceGaze/p00/Calibration/screenSize.mat /mnt/d/Downloads/MPIIFaceGaze/MPIIFaceGaze/p00/p00.txt 
